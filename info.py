...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002462481038'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5818756576').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002441226780').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002296002650')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AlphazMovies_Zone')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Links_Tutorialz/14')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Alphaz_Updates') # Support Chat Link Without https:// or @
